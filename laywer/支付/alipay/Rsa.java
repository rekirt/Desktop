...
public class Rsa {
	...
	public static String sign(String content, String privateKey) {
		...
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(Base64.decode(privateKey));//ͨ��֧�������ṩ�Ĺ�Կ�����Ӧ��˽Կ
			KeyFactory keyf = KeyFactory.getInstance("RSA");
			PrivateKey priKey = keyf.generatePrivate(priPKCS8);
			
			java.security.Signature signature = java.security.Signature.getInstance(SIGN_ALGORITHMS);//���ǩ���㷨ʵ��
